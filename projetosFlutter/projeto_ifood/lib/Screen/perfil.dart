import 'package:projeto_ifood/Componentes/circle_avatar.dart';
import 'package:projeto_ifood/Componentes/listTile.dart';
          ...
          Row(
            children: [
              ...
              const Padding(
                ...
                child: Text('Usuário', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
